...
\begin{comment}
- vurdere å a ha med graf på løsningstid og gameweeks. 
- modellen er kjørt for flere set av number of gameweeks 
- man ser at antall rows ikke blir redusert så mye, men at antall constraints minker mer 
- man ser at økningen i computational time ikke er så bratt når modellen løses for opptil 20 gameweeks, men etter det øker comp.time betraktelig og man klarer ikke å finne optimal løsning innenfor max tid.
- allikevel er et gap på 0.75 nær optimal løsning og er mer enn nok til å brukes som et benchmark 
\end{comment}
