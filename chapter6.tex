...
%Without taking it to the extreme, this quote by \cite{brooks} is kept in the back of our minds: \textit{"Some econometricians would go as far as to suggest that the statistical adequacy of a model (...), is largely irrelevant if the model produces accurate forecasts."}
